"""
Provides a compatibility layer for NumPy and CuPy.
It allows seamless switching between the two libraries, enabling GPU acceleration
when available.
"""
...
if __name__ == "__main__":
    ...
    print(isinstance(arr, np_ndarray_instance) and isinstance(
        arr, _np.ndarray))  # Should print: True
